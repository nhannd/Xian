...
namespace ClearCanvas.Dicom.Iod
{
	public class VoiDataLut : DataLut
	{
		...
		/// workaround David Clunie suggests (see http://groups.google.com/group/comp.protocols.dicom/browse_thread/thread/6a033444802a35fc/0f0a9a1e35c1468e?lnk=gst&q=VOI+LUT).
		/// </remarks>
