...
create table SopInstance_ (Oid_ UNIQUEIDENTIFIER not null, TransferSyntaxUid_ NVARCHAR(64) null, InstanceNumber_ INT null, SopInstanceUid_ NVARCHAR(64) null, SopClassUid_ NVARCHAR(64) null, SpecificCharacterSet_ NVARCHAR(64) null, LocationUri_ NVARCHAR(256) null, SeriesOid_ UNIQUEIDENTIFIER null, primary key (Oid_));
