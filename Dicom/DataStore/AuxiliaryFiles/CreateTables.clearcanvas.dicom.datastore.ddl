...
create table Study_ (StudyOid_ UNIQUEIDENTIFIER not null, ProcedureCodeSequenceCodingSchemeDesignator_ NVARCHAR(16) null, StudyId_ NVARCHAR(16) null, StudyTime_ NVARCHAR(16) null, StudyDate_ NVARCHAR(26) null, AccessionNumber_ NVARCHAR(16) null, StudyInstanceUid_ NVARCHAR(64) null, StudyDescription_ NVARCHAR(64) null, SpecificCharacterSet_ NVARCHAR(64) null, ProcedureCodeSequenceCodeValue_ NVARCHAR(16) null, StoreTime_ DATETIME null, PatientsName_ NVARCHAR(256) null, PatientId_ NVARCHAR(64) null, PatientsSex_ NVARCHAR(16) null, PatientsBirthDate_ NVARCHAR(16) null, primary key (StudyOid_));
