...
namespace ClearCanvas.Ris.Client
{
	...
	public class OrderEditorComponent : ApplicationComponent
	{
		...
		private bool _autoGenerateVisit = true;
		...
		public OrderEditorComponent(EntityRef patientRef, EntityRef profileRef, EntityRef orderRef, Mode mode)
		{
			...
			this.Validation.Add(new ValidationRule("SelectedVisit",
				component => new ValidationResult(_autoGenerateVisit || _selectedVisit != null, SR.MessageVisitRequired)));
		...
		public override void Start()
		{
			...
			Async.Request(this,
				...
				formChoicesResponse =>
				{
					_autoGenerateVisit = formChoicesResponse.VisitAutoGenerated;
