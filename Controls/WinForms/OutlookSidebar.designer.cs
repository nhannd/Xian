namespace ClearCanvas.Controls.WinForms
{
	partial class OutlookSidebar
	{
		...
		private void InitializeComponent()
		{
			...
			this._subHeaderStrip = new ClearCanvas.Controls.WinForms.HeaderStrip();
			this._subHeaderStripLabel = new System.Windows.Forms.ToolStripLabel();
			this._mainHeaderStrip = new ClearCanvas.Controls.WinForms.HeaderStrip();
			this._mainHeaderStripLabel = new System.Windows.Forms.ToolStripLabel();
			this._stackStrip = new ClearCanvas.Controls.WinForms.StackStrip();
			this._overflowStrip = new ClearCanvas.Controls.WinForms.BaseStackStrip();
			...
			this._stackStripSplitter.SplitterDistance = 312;
			...
			this._userPanel.Size = new System.Drawing.Size(312, 268);
			this._userPanel.TabIndex = 2;
			// 
			// _subHeaderStrip
			// 
			this._subHeaderStrip.AutoSize = false;
			this._subHeaderStrip.Font = new System.Drawing.Font("Arial", 10.5F, System.Drawing.FontStyle.Bold);
			this._subHeaderStrip.ForeColor = System.Drawing.Color.White;
			this._subHeaderStrip.GripStyle = System.Windows.Forms.ToolStripGripStyle.Hidden;
			this._subHeaderStrip.HeaderStyle = ClearCanvas.Controls.WinForms.AreaHeaderStyle.Small;
			...
			this._stackStrip.Size = new System.Drawing.Size(312, 278);
			...
			this._overflowStrip.Location = new System.Drawing.Point(0, 278);
