...
namespace ClearCanvas.Desktop.Actions
{
    ...
    /// that contains the type of the action target object, and secondarily searching the Desktop assembly.
    /// </summary>
    internal class ActionResourceResolver : ResourceResolver
    {
        ...
        internal ActionResourceResolver(object actionTarget)
            :base(new Assembly[] { actionTarget.GetType().Assembly, typeof(ActionResourceResolver).Assembly } )
        {
        }
    }
}
