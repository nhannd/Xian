...
{
	/// <summary>
	/// Owls implementation of <see cref="IReportingWorklistItemBroker"/>.
	/// </summary>
	[ExtensionOf(typeof(BrokerExtensionPoint))]
	public class OwlsReportingWorklistItemBroker : ReportingWorklistItemBroker
	{
		public OwlsReportingWorklistItemBroker()
			: base(
				new OwlsReportingWorklistItemQueryBuilder(),
