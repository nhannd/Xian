...
namespace ClearCanvas.Healthcare
{
    ...
    public partial class TechnologistCheckedInWorklist : ClearCanvas.Healthcare.Worklist
    {
        /// <summary>
        ...
        {
            return (IList)GetBroker<IModalityWorklistBroker>(context).GetCheckedInWorklist(this);
        }
