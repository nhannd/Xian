...
{
    [MenuAction("apply", "dicomeditor-toolbar/Quick Anonymize")]
    [ButtonAction("apply", "dicomeditor-contextmenu/Quick Anonymize")]
    [Tooltip("apply", "Anonymize all loaded files with one click")]
    [IconSet("apply", IconScheme.Colour, "Icons.QuickAnonymizeToolSmall.png", "Icons.QuickAnonymizeToolMedium.png", "Icons.QuickAnonymizeToolLarge.png")]
