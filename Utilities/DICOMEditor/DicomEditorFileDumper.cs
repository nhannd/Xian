...
namespace ClearCanvas.Utilities.DicomEditor
{
    public class DicomEditorFileDumper
    {
        ...
        protected IToolContext _toolContext;
    ...
    public class DicomEditorImageViewerFileDumper : DicomEditorFileDumper
    {
        ...
        public override void LaunchAsShelf()
        {
            ApplicationComponent.LaunchAsShelf(
                            (_toolContext as IImageViewerToolContext).DesktopWindow,
                            _component,
                            "DICOM Editor",
        ...
        {
            DicomPresentationImage image = (_toolContext as IImageViewerToolContext).Viewer.SelectedPresentationImage as DicomPresentationImage;
    ...
    public class DicomEditorLocalImageExplorerFileDumper : DicomEditorFileDumper
    {
        ...
        {
            ApplicationComponent.LaunchAsShelf(
                            (_toolContext as ILocalImageExplorerToolContext).DesktopWindow,
                            _component,
                            "DICOM Editor",
                            ShelfDisplayHint.DockRight,
                            delegate(IApplicationComponent component) { _component = null; });
        ...
        public override IEnumerable<FileDicomImage> GetFiles()
        {
            ...
            foreach (string rawPath in (_toolContext as ILocalImageExplorerToolContext).SelectedPaths)
            {
