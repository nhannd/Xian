...
{
    /// <summary>
    /// Helper class to compare two bitmaps
    /// </summary>
        ...
        public static ImageComparisonResult Compare(ref Bitmap bmp1, ref Bitmap bmp2)
        {
            ...
            for (int y = 0; y < bmp1.Height; y++)
            {
                for (int x = 0; x < bmp1.Width; x++)
                {
                    ...
                    result.Channels[0].AddSample(Math.Abs(c1.R - c2.R));
                    result.Channels[1].AddSample(Math.Abs(c1.G - c2.G));
                    result.Channels[2].AddSample(Math.Abs(c1.B - c2.B));
                }
            }
