...
{
	public class RectangleInteractiveGraphicAnnotationSerializer : GraphicAnnotationSerializer<RectangleInteractiveGraphic>
	{
		protected override void Serialize(RectangleInteractiveGraphic graphic, GraphicAnnotationSequenceItem serializationState)
		{
			if (!graphic.Visible)
