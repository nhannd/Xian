...
{
    partial class DicomNetworkReceiveQueueApplicationComponentControl
    {
        /// <summary> 
        ...
        private void InitializeComponent()
        {
			...
			this._titleBar.Text = "Receive Queue";
			// 
			// DicomNetworkReceiveQueueApplicationComponentControl
			// 
			this.AutoScaleDimensions = new System.Drawing.SizeF(6F, 13F);
			this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
			this.Controls.Add(this._receiveTable);
			this.Controls.Add(this._titleBar);
			this.Name = "DicomNetworkReceiveQueueApplicationComponentControl";
