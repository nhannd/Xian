    ...
    public class LocalDataStoreDashboardContent : DashboardContent
    {
        ...
        private void OnSearch(object sender, EventArgs e)
        {
            using (new CursorManager(_detailView, Cursors.WaitCursor))
            {
                ...
                IStudyFinder localStudyFinder = ImageWorkspace.StudyManager.StudyFinders["My DataStore"];
        ...
        private void OpenStudy(StudyItem item)
        {
            using (new CursorManager(_detailView, Cursors.WaitCursor))
            {
                IStudyLoader studyLoader = ImageWorkspace.StudyManager.StudyLoaders[item.StudyLoaderName];
