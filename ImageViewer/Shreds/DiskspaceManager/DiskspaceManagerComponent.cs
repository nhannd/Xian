...
{
    /// <summary>
    /// Extension point for views onto <see cref="DiskspaceManagerComponent"/>
    /// </summary>
    [ExtensionPoint]
    public class DiskspaceManagerComponentViewExtensionPoint : ExtensionPoint<IApplicationComponentView>
    {
    }

    public interface IDiskspaceManager
    {
        void SetComponent(DiskspaceManagerComponent component);
    ...
    /// <summary>
    /// DiskspaceManagerComponent class
    /// </summary>
    [AssociateView(typeof(DiskspaceManagerComponentViewExtensionPoint))]
    public class DiskspaceManagerComponent : ApplicationComponent
    {
        /// <summary>
        /// Constructor
        /// </summary>
        public DiskspaceManagerComponent()
        {
