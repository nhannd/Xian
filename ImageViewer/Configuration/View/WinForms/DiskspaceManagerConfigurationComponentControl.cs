...
namespace ClearCanvas.ImageViewer.Configuration.View.WinForms
{
    ...
    public partial class DiskspaceManagerConfigurationComponentControl : ApplicationComponentUserControl
    {
            ...
            : base(component)
        {
            ...
            _txtFrequency.DataBindings.Add("Text", _component, "CheckFrequency", true, DataSourceUpdateMode.OnPropertyChanged);
            ...
            _txtFrequency.DataBindings.Add("Enabled", _component, "Enabled", true, DataSourceUpdateMode.OnPropertyChanged);
