...
namespace ClearCanvas.ImageViewer.Imaging.Tests
{
    ...
    public class ImageRendererBilinearInterpolationTests
    {
        ...
        {
            ClearCanvas.ImageViewer.Renderer.GDI.ImageRenderer.InterpolationMethod =
                ClearCanvas.ImageViewer.Renderer.GDI.ImageRenderer.InterpolationMethods.BILINEAR;
            _tracePhantom = true;
            _traceBitmap = true;
            _trace = true;
        }
