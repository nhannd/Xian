...
namespace ClearCanvas.ImageViewer.DynamicOverlays
{
	...
	public class CompassStretchIndicatorCursorProvider : ICursorTokenProvider
	{
		...
		private ControlPointsGraphic _controlPoints;

		public CompassStretchIndicatorCursorProvider(ControlPointsGraphic controlPoints)
			: this(controlPoints, true)
		{
		}

		public CompassStretchIndicatorCursorProvider(ControlPointsGraphic controlPoints, bool installDefaults)
		{
