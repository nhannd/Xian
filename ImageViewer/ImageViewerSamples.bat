...
copy "..\..\..\..\ImageViewer\Tools\ImageProcessing\RoiAnalysis\bin\%1\ClearCanvas.ImageViewer.Tools.ImageProcessing.RoiAnalysis.dll" ".\plugins"
copy "..\..\..\..\ImageViewer\Tools\ImageProcessing\RoiAnalysis\View\WinForms\bin\%1\ClearCanvas.ImageViewer.Tools.ImageProcessing.RoiAnalysis.View.WinForms.dll" ".\plugins"
