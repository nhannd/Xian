...
namespace ClearCanvas.ImageViewer.Web {
    ...
    internal class SR {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Diagnostic (lossless).
        /// </summary>
        internal static string ImageQualityMenuDiagnostic {
            get {
                return ResourceManager.GetString("ImageQualityMenuDiagnostic", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Diagnostic (dynamic).
        /// </summary>
        internal static string ImageQualityMenuDynamic {
            get {
                return ResourceManager.GetString("ImageQualityMenuDynamic", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Lossy (performance).
        /// </summary>
        internal static string ImageQualityMenuLossyPerformance {
            get {
                return ResourceManager.GetString("ImageQualityMenuLossyPerformance", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Lossy (quality).
        /// </summary>
        internal static string ImageQualityMenuLossyQuality {
            get {
                return ResourceManager.GetString("ImageQualityMenuLossyQuality", resourceCulture);
            }
        }
