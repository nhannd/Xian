namespace ClearCanvas.ImageServer.Model.SqlServer2005.CodeGenerator
{
	partial class MainForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.textBoxEntityImplementationNamespace.Text = "ClearCanvas.ImageServer.Model.SqlServer2005.EntityBrokers";
			...
			this.textBoxEntityImplementationFolder.Text = "c:\\Projects\\ClearCanvas\\ImageServer\\Model\\SqlServer2005\\EntityBrokers";
			// 
			// groupBox1
			// 
			...
			this.Name = "MainForm";
			this.Text = "ClearCanvas.ImageServer.Model.SqlServer2005.CodeGenerator";
