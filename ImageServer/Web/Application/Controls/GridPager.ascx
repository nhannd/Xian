    ...
    <tr>
        <td align="left" style="padding-left: 6px;" >
            <table cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td>
                        <div style="background: #e1eff7; border-bottom: solid 1px #b8d9ee; padding-top: 1px; padding-bottom: 1px; width: 175px; text-align: center;">
        ...
        <td align="right" style="padding-right: 6px; padding-bottom: 2px; padding-top: 0px;">
            ...
            <table cellspacing="0" cellpadding="0">
                ...
                <td>
                    <div style="background: #e1eff7; border-bottom: solid 1px #b8d9ee; padding-left: 4px; padding-right: 4px; padding-top: 1px; margin-bottom: 1px;">
                            <asp:Label ID="Label3" runat="server" Text="Page" CssClass="GlobalGridPagerLabel" />
                            <asp:TextBox ID="CurrentPage" runat="server" width="35px" CssClass="GridViewTextBox" style="font-size: 12px; text-align: right;" />
                            <asp:Label ID="PageCountLabel" runat="server" Text="Label" CssClass="GlobalGridPagerLabel" />                
                            <aspAjax:MaskedEditExtender runat="server" ID="CurrentPageMask" MaskType="Number" TargetControlID="CurrentPage" Mask="999999" PromptCharacter="" AutoComplete="false" MessageValidatorTip="false" AcceptNegative="None" InputDirection="LeftToRight"/>
                    </div>                            
                </td>
                ...
                <td>
                        ...
                        <asp:LinkButton ID="ChangePageButton" runat="server" CommandArgument="ChangePage" CommandName="Page"
                OnCommand="PageButtonClick" Text="" />                
                </td>
