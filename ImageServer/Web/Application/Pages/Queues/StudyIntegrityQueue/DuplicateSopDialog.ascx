                ...
                <ContentTemplate>                
                    <asp:Panel ID="Panel1" runat="server" CssClass="ReconcilePanel">
                        <asp:Table ID="Table1" runat="server">
                            ...
                            <asp:TableRow>
                                <asp:TableCell ColumnSpan="3"><div class="StudyInstanceUIDMessage"><%=SR.StudyInstanceUID %>: <asp:Label ID="StudyInstanceUIDLabel" runat="server" Text='<%# DuplicateEntryDetails.StudyInstanceUid %>'></asp:Label></div></asp:TableCell>
                            </asp:TableRow>
                                        ...
                                        <asp:TableRow>
                                            <asp:TableCell>
                                                <div class="StudyInformation">
                                                 <table>
                                                    <tr>
                                                        <td width="130px" class="DialogLabelBackground"><asp:Label ID="Label1" runat="server" CssClass="DialogTextBoxLabel"><%=Labels.PatientName%></asp:Label></td>
                                                ...
                                                <table cellpadding="0" cellspacing="0" width="100%">
                                                    <tr><td style="padding-left: 10px; padding-right: 10px;"><div class="SeriesTitle"><%=Labels.Series%></div></td></tr>
                                                </table>
                                                            ...
                                                            <div class="ReconcileGridViewPanel" style="height:150px;">
                                                                <asp:GridView runat="server" CssClass="ReconcileSeriesGridView" ID="ExistingPatientSeriesGridView" width="440px" AutoGenerateColumns="false">
                                                                    <Columns>
		                                                                ...
		                                                                <asp:TemplateField HeaderText="<%$Resources: ColumnHeaders,SeriesDescription%>" HeaderStyle-HorizontalAlign="left" ItemStyle-HorizontalAlign="Left">						                                                        
		                                                                    <ItemTemplate>
                                            ...
                                            <asp:TableCell style="padding: 0px 10px 10px 10px;">
                                                <asp:Panel ID="Panel2" runat="server" CssClass="ReconcileButtonsTable">
                                                    <asp:Table runat="server" ID="OptionTable" Width="100%" CellPadding="0" CellSpacing="0" style="margin-left: 5px;">
                                                        ...
                                                        <asp:TableRow>
                                                            <asp:TableCell><asp:radiobutton runat="server" ID="UseExistingSopRadioButton" Text="<%$Resources: InputLabels, SIQ_ReconcileDuplicateDialog_UseExistingDemographics %>" GroupName="DuplicateSopDecision" Checked="true"/></asp:TableCell>
                                                            <asp:TableCell><asp:radiobutton runat="server" ID="UseDuplicateRadioButton" Text="<%$Resources: InputLabels, SIQ_ReconcileDuplicateDialog_UseDuplicateDemographics %>" GroupName="DuplicateSopDecision" Checked="false"/></asp:TableCell>
                                                        </asp:TableRow>
                                                        <asp:TableRow >
                                                            <asp:TableCell><asp:radiobutton runat="server" ID="ReplaceAsIsRadioButton" Text="<%$Resources: InputLabels, SIQ_ReconcileDuplicateDialog_ReplaceAsIs %>" GroupName="DuplicateSopDecision" Checked="false"/></asp:TableCell>
                                                            <asp:TableCell><asp:radiobutton runat="server" ID="DeleteDuplicateRadioButton" Text="<%$Resources: InputLabels, SIQ_ReconcileDuplicateDialog_DeleteDuplicates %>" GroupName="DuplicateSopDecision" CssClass="ReconcileRadioButton"/></asp:TableCell>
                                                        </asp:TableRow>
                                                        <asp:TableRow>
                ...
                <ContentTemplate>
                    <asp:Panel ID="Panel4" runat="server" Height="100%">
                        ...
                        <table width="100%">
                            ...
                            <tr >
                                <td class="DialogLabelBackground" style="margin-left:5px;"><asp:Label ID="Label12" runat="server" CssClass="DialogTextBoxLabel" Text="<%$Resources: Labels,SIQ_ReconcileDialog_DuplicateSOPLocation %>"></asp:Label></td>
