...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ProcessDuplicateWorkQueueDetailsView.ascx.cs" Inherits="ClearCanvas.ImageServer.Web.Application.Pages.Queues.WorkQueue.Edit.ProcessDuplicateWorkQueueDetailsView" %>

    <asp:DetailsView ID="ProcessDuplicateInfoDetailsView" runat="server" AutoGenerateRows="False" CellPadding="2" 
    ...
    <Fields>
        ...
        <asp:BoundField HeaderText="<%$Resources: DetailedViewFieldLabels, WorkQueue_DuplicateStorageLocation %>" HeaderStyle-CssClass="StudyDetailsViewHeader" DataField="DuplicateStorageLocationPath" />
