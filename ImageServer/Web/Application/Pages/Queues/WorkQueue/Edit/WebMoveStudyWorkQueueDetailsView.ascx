<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WebMoveStudyWorkQueueDetailsView.ascx.cs" Inherits="ClearCanvas.ImageServer.Web.Application.Pages.Queues.WorkQueue.Edit.WebMoveStudyWorkQueueDetailsView" %>

<asp:DetailsView ID="WebMoveStudyDetailsView" runat="server" AutoGenerateRows="False" CellPadding="2"
...
<asp:TemplateField HeaderText="Accession Number">
        ...
        <asp:BoundField HeaderText="Failure Description" HeaderStyle-CssClass="StudyDetailsViewHeader" DataField="FailureDescription" HeaderStyle-VerticalAlign="Top"/>
