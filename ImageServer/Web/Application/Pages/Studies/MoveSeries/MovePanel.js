...
if (window.__registeredTypes['ClearCanvas.ImageServer.Web.Application.Pages.Studies.MoveSeries.MovePanel']==null)
{

    Type.registerNamespace('ClearCanvas.ImageServer.Web.Application.Pages.Studies.MoveSeries');
    ...
    //
    /////////////////////////////////////////////////////////////////////////////////////////////////////////
    ClearCanvas.ImageServer.Web.Application.Pages.Studies.MoveSeries.MovePanel = function(element) { 
        ClearCanvas.ImageServer.Web.Application.Pages.Studies.MoveSeries.MovePanel.initializeBase(this, [element]);
    ...
    //
    /////////////////////////////////////////////////////////////////////////////////////////////////////////
    ClearCanvas.ImageServer.Web.Application.Pages.Studies.MoveSeries.MovePanel.prototype = 
    {
        initialize : function() {
            ClearCanvas.ImageServer.Web.Application.Pages.Studies.MoveSeries.MovePanel.callBaseMethod(this, 'initialize');        
        ...
        dispose : function() {
            ...
            ClearCanvas.ImageServer.Web.Application.Pages.Studies.MoveSeries.MovePanel.callBaseMethod(this, 'dispose');
    ...
    // Register the class as a type that inherits from Sys.UI.Control.
        ...
        ClearCanvas.ImageServer.Web.Application.Pages.Studies.MoveSeries.MovePanel.registerClass('ClearCanvas.ImageServer.Web.Application.Pages.Studies.Move.MovePanel', Sys.UI.Control);
