...
<asp:UpdatePanel ID="SearchUpdatePanel" runat="server" UpdateMode="Conditional">
    <ContentTemplate>
        ...
        <table cellpadding="0" cellspacing="0" width="100%">
            ...
            <tr>
                <td class="MovePanelTd">
                    <asp:Image runat="server" SkinID="Spacer" Height="4" />
                </td>
            </tr>
            <tr>
                <td class="MovePanelTd">
            ...
            <tr>
                <td class="MovePanelTd">
                    <asp:Image ID="Image3" runat="server" SkinID="Spacer" Height="4" />
                </td>
            </tr>
            <tr>
                ...
                <td class="SeriesDetailsContent">
                    <table cellpadding="2" cellspacing="0" class="ToolbarButtonPanel" width="100%">
                        <tr>
                            ...
                            <td style="vertical-align: bottom;">
                                <asp:Label runat="server" Text="<%$ Resources: Labels, DeviceType %>" CssClass="SearchTextBoxLabel" /><br />
                                <asp:ListBox ID="DeviceTypeFilter" runat="server" CssClass="SearchDropDownList" SelectionMode="Multiple" />
                            </td>
                            <td style="padding-right: 6px; vertical-align: bottom; padding-top: 5px;">
