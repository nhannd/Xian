...
<tr>
  ...
  <td class="SeriesDetailsContent">
     <table cellpadding="2" cellspacing="0" class="ToolbarButtonPanel" width="100%" >
        <tr>
            <td align="left" nowrap="nowrap" valign="bottom" style="padding-top: 5px;"><asp:Label ID="Label1" runat="server" Text="<%$ Resources: Labels, AETitle %>" CssClass="SearchTextBoxLabel" /><br /><asp:TextBox ID="AETitleFilter" runat="server" CssClass="SearchTextBox" /></td>
