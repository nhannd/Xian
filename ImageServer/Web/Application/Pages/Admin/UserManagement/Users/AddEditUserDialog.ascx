    ...
    <ContentTemplate>
        ...
        <asp:Table runat="server" skinID="NoSkin" CellSpacing="3" CellPadding="3">
            ...
            <asp:TableRow runat="server" ID="UserNameRow">
                <asp:TableCell runat="server"><asp:Label ID="Label2" runat="server" Text="<%$Resources: InputLabels, AdminUsers_AddEditDialog_UserID %>" CssClass="DialogTextBoxLabel" /></asp:TableCell><asp:TableCell><asp:TextBox runat="server" ID="UserLoginId" CssClass="DialogTextBox"></asp:TextBox><asp:HiddenField ID="OriginalUserLoginId" runat="server" /></asp:TableCell>
            ...
            <asp:TableRow>
                <asp:TableCell CssClass="DialogTextBoxLabel" Wrap="false"><asp:Label ID="Label1" runat="server" Text="<%$Resources: InputLabels, AdminUsers_AddEditDialog_Name %>" CssClass="DialogTextBoxLabel" /></asp:TableCell><asp:TableCell><asp:TextBox runat="server" ID="DisplayName" CssClass="DialogTextBox"></asp:TextBox></asp:TableCell>
