<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ThrottleSettingsTab.ascx.cs" Inherits="ClearCanvas.ImageServer.Web.Application.Pages.Admin.Configure.Devices.ThrottleSettingsTab" %>
...
Specify the maximum number of simultaneous connections Image Server can initiate for this device.
</div>
<table width="100%">
    <tr>
        <td><span style="white-space:nowrap">Number of Connections Allowed:</span></td>
        <td>
            <table>
                <tr>
                    <td><asp:RadioButton runat="server" ID="UnlimitedCheckBox" GroupName="MaxConnection" Text="Unlimited" /></td>
                    <td><asp:RadioButton runat="server" ID="LimitedCheckBox" GroupName="MaxConnection" Text="Limited" /></td>
                    <td>
                        <table>
                            <tr>
