										...
										<tr>
                                            ...
                                            <td align="left" valign="bottom">
                                                ...
                                                <ccValidator:RegularExpressionFieldValidator
                                                        ...
                                                        ValidationExpression="(20|21|22|23|[01]\d):[0-5][0-9]:[0-5][0-9].[0-9][0-9][0-9]" Text="Invalid Time" Display="None" IgnoreEmptyValue="true">
                                                </ccValidator:RegularExpressionFieldValidator>
                                            </td>
                                            <td align="left" valign="bottom">
                                            ...
                                            <td align="left" valign="bottom">
                                                ...
                                                <ccValidator:RegularExpressionFieldValidator
                                                        ...
                                                        ValidationExpression="(20|21|22|23|[01]\d):[0-5][0-9]:[0-5][0-9].[0-9][0-9][0-9]" Text="Invalid Time" Display="None">
                                                </ccValidator:RegularExpressionFieldValidator>
                                            </td>                                            
											<td align="left" valign="bottom">
