...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="DescriptionPlaceHolder">
    ...
    <asp:Label ID = "DescriptionLabel" runat="server">
        This message is being displayed because there has been no activity in the past <asp:Label ID="TimeoutMinutes" runat="server"></asp:Label> minute(s). For security purposes, 
