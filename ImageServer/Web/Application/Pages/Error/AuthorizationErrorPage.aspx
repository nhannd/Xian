...
<asp:Content runat="server" ContentPlaceHolderID="UserEscapePlaceHolder">
    <table width="100%" class="UserEscapeTable"><tr><td class="UserEscapeCell"><asp:LinkButton ID="LinkButton1" runat="server" CssClass="UserEscapeLink" OnClick="DefaultPage_Click">Default Page</asp:LinkButton></td><td class="UserEscapeCell"><asp:LinkButton ID="LogoutButton" runat="server" CssClass="UserEscapeLink" OnClick="Logout_Click">Logout</asp:LinkButton></td><td style="width: 30%" align="center"><a href="javascript:window.close()" class="UserEscapeLink">Close</a></td></tr></table>
</asp:Content>