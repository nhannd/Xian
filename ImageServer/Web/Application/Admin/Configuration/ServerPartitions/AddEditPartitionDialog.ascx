...
<asp:UpdatePanel ID="UpdatePanel" runat="server" UpdateMode="Conditional">
    <ContentTemplate>
                    ...
                    <table id="Table2" runat="server" cellspacing="3" style="text-align: left" width="100%">
                        <tr id="Tr1" runat="server">
                            <td id="Td1" runat="server" valign="bottom">
                                AE Title<br />
                                <asp:TextBox ID="AETitleTextBox" runat="server" MaxLength="16" ValidationGroup="vg1"></asp:TextBox><asp:Image
                                    ID="AETitleHelpImage" runat="server" ImageAlign="Top" ImageUrl="~/images/icons/HelpSmall.png"
                                ...
                                <clearcanvas:regularexpressionfieldvalidator id="RegularExpressionFieldValidator2"
                                    ...
                                    validationgroup="vg1" PopupHelpControlID="AETitleHelpImage"></clearcanvas:regularexpressionfieldvalidator>
                            </td>
                        ...
                        <tr id="Tr2" runat="server">
                            <td id="Td4" runat="server" style="height: 29px" valign="bottom">
                                ...
                                <clearcanvas:RangeValidator 
                                                ...
                                                MinValue = "1"
                                                MaxValue = "65535"
                                                ErrorMessage="Parition Port must be between 1 and 65535"
                                                Display="None" PopupHelpControlID="PortHelpImage"></clearcanvas:RangeValidator>
                            ...
                            <td id="Td6" runat="server" align="left" colspan="1" style="height: 29px" valign="bottom">
                                Folder Name<br />
                                <asp:TextBox ID="PartitionFolderTextBox" runat="server" CausesValidation="true" ValidationGroup="vg1"></asp:TextBox><asp:Image
                                ...
                                <clearcanvas:ConditionalRequiredFieldValidator ID="Conditionalrequiredfieldvalidator1"
                                    ...
                                    InvalidInputBackColor="#FAFFB5" 
                                    ValidationGroup="vg1" PopupHelpControlID="FolderHelpImage"></clearcanvas:ConditionalRequiredFieldValidator></td>
                        </tr>
        ...
        <cc1:NumericUpDownExtender ID="PortTextBoxNumericUpDownExtender" runat="server" Maximum="65535"
            Minimum="1" TargetControlID="PortTextBox" Width="100">
