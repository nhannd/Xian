...
<asp:Panel ID="Panel2" runat="server" CssClass="CSSAccordianResultPanelContainer">
    <asp:Panel ID="Panel3" runat="server" CssClass="CSSAccordianResultPanelBorder">
        <asp:Panel ID="Panel4" runat="server" CssClass="CSSAccordianResultPanelContent">
            <asp:Table ID="Table1" runat="server" Width="100%" CellPadding="0" CellSpacing="0"
                        ...
                        <asp:Panel ID="Panel8" runat="server" CssClass="CSSAccordianHeaderPanelContainer">
                            <asp:Panel ID="Panel9" runat="server" CssClass="CSSAccordianHeaderPanelBorder">
                                <asp:Panel ID="Panel10" runat="server" CssClass="CSSAccordianHeaderPanelContent">
                                    <asp:Label ID="PatientName" CssClass="CSSAccordianHeaderText" runat="server" Text="Patient Name"
                                        EnableViewState="False" Width="24%" />
                ...
                <asp:TableRow>
                    <asp:TableCell>
                        <asp:Panel ID="Panel1" runat="server" CssClass="CSSAccordianResultListContainer"
                            ScrollBars="Vertical">
                ...
                <asp:TableFooterRow Width="100%">
                    <asp:TableCell>
                        <asp:Panel ID="Panel5" runat="server" CssClass="CSSGridPagerPanelContainer">
