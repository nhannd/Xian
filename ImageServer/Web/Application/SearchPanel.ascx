                    ...
                    <asp:TableCell ColumnSpan="2">
                        <asp:Panel runat="server" CssClass="GridViewPanelContainer">
                                <asp:Panel runat="server" CssClass="GridViewPanelBorder" >
                                    <localAsp:WorkQueueSearchResultPanel ID="workQueueItemListPanel" Height="500px" AllowPaging="true" PageSize="20" runat="server"></localAsp:WorkQueueSearchResultPanel>
                                </asp:Panel>                        
                        </asp:Panel>
