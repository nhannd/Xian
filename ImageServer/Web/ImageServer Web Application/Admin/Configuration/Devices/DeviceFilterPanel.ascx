<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DeviceFilterPanel.ascx.cs" Inherits="ImageServerWebApplication.Admin.Configuration.Devices.DeviceFilterPanel" %>
