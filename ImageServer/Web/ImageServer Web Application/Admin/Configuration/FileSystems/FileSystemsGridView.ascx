<%@ Control Language="C#" AutoEventWireup="true" Inherits="ImageServerWebApplication.Admin.Configuration.FileSystems.FileSystemsGridView"
    ...
    <asp:Panel ID="Panel2" runat="server" BorderColor="Silver" BorderWidth="1px" Height="400px">
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" ForeColor="#333333"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="FileSystemPath" HeaderText="Path"></asp:BoundField>
                <asp:BoundField DataField="HighWatermark" HeaderText="High Watermark"></asp:BoundField>
                <asp:BoundField DataField="LowWatermark" HeaderText="Low Watermark"></asp:BoundField>
                <asp:BoundField DataField="PercentFull" HeaderText="Percent Full"></asp:BoundField>
            </Columns>
