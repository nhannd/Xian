<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ServerPartitionPanel.ascx.cs" Inherits="ImageServerWebApplication.Admin.Configuration.ServerPartitions.ServerPartitionPanel" %>
