<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ServerPartitionGridPanel.ascx.cs" Inherits="ImageServerWebApplication.Admin.Configuration.ServerPartitions.ServerPartitionGridPanel" %>
